...
//		check for null & not instance of DListIterator
...
//		initialize variable
		DListNode prevStart1 = ((DListIterator) s1).currentNode.previousNode;
		DListNode afterFinal1 = ((DListIterator) f1).currentNode.nextNode;
		DListNode prevStart2 = ((DListIterator) s2).currentNode.previousNode;
		DListNode afterFinal2 = ((DListIterator) f2).currentNode.nextNode;
//		for swap adjacent
		if (((DListIterator) f1).currentNode.nextNode.equals(((DListIterator) s2).currentNode)) {
			prevStart1.nextNode = afterFinal1;
			prevStart2.nextNode = afterFinal2;
			afterFinal1.previousNode = prevStart1;
			afterFinal2.previousNode = prevStart2;
...
//			change start node 1
			prevStart1.nextNode = ((DListIterator) s2).currentNode;
			((DListIterator) s2).currentNode.previousNode = prevStart1;
//			change final node 1
			afterFinal1.previousNode = ((DListIterator) f2).currentNode;
			((DListIterator) f2).currentNode.nextNode = afterFinal1;
//			change start node 2
			prevStart2.nextNode = ((DListIterator) s1).currentNode;
			((DListIterator) s1).currentNode.previousNode = prevStart2;
//			change final node 2
			afterFinal2.previousNode = ((DListIterator) f1).currentNode;
			((DListIterator) f1).currentNode.nextNode = afterFinal2;
		}
	}
}